extends RefCounted
class_name ___Testiny_Expectation
...
static func expect(value: Variant) -> ___Testiny_Expectation:
	return ___Testiny_Expectation.new(value)

## negates the result of following expectation
## [codeblock]expect(1).NOT.to_equal(2)[/codeblock]
var NOT: ___Testiny_Expectation:
	get:
